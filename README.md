...
1. Python (3.10.12) – [native-models/pytorch](native-models/pytorch)

2. R  (4.3.2)  – [native-models/rtorch](native-models/rtorch)

3. Julia (1.9.4) – [native-models/flux](native-models/flux)
...
3. STAC-ML metadata are documented for each native model, and also Docker images are available in Docker Hub: https://hub.docker.com/repositories/sanjushree
